...
export default function SupplierInvoicesTable({ invoices: initialInvoices }: { invoices: Invoice[] }) {
  const [invoices, setInvoices] = useState(initialInvoices)
  const router = useRouter()

  console.log('Supplier Invoices:', invoices)
        ...
        <Table>
          ...
          <TableBody>
            {invoices.map((invoice) => (
              <TableRow key={invoice.id} className="cursor-pointer" onClick={() => router.push(`/invoices/supplier/${invoice.id}`)}>
